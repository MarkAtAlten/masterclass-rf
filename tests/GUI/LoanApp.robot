...
UI Exercise 1
    ...
    Click Element    //a[@id='request1']
    BuiltIn.Sleep    1
    Click element    xpath://button/span[text()="Groceries"]/..
    Press keys       xpath://button/span[text()="Groceries"]/..    ESC
    Click Element    xpath://label[text()=" Mini-loan (minimum €300) "]
    Click Element    xpath://label[text()=" Mini-loan (minimum €300) "]
    Press keys       xpath://input[@placeholder="Amount"]    "300"
...
UI exercise 3
    ...
    Element should contain    //div[@class="modal-body"]/p    A Revolving Credit or a Personal loan is probably the way to go.
